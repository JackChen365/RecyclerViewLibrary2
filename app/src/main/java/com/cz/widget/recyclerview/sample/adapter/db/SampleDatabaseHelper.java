package com.cz.widget.recyclerview.sample.adapter.db;
 ...
 * @see com.cz.widget.recyclerview.adapter.support.cursor.CursorRecyclerAdapter
 * @see com.cz.widget.recyclerview.sample.adapter.CursorSampleActivity
 */
