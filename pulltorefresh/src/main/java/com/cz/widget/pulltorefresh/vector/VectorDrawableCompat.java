 ...
 */
class VectorDrawableCompat extends Drawable {
    ...
    private void updateStateFromTypedArray(TypedArray a, XmlPullParser parser)
        ...
        final ColorStateList tint =
                a.getColorStateList(AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_TINT);
        if (tint != null) {
            state.mTint = tint;
        }
        ...
        pathRenderer.mBaseWidth = a.getDimension(
                AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_WIDTH, pathRenderer.mBaseWidth);
        pathRenderer.mBaseHeight = a.getDimension(
                AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_HEIGHT, pathRenderer.mBaseHeight);
        ...
        final float alphaInFloat = TypedArrayUtils.getNamedFloat(a, parser, "alpha",
                AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_ALPHA, pathRenderer.getAlpha());
        pathRenderer.setAlpha(alphaInFloat);

        final String name = a.getString(AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_NAME);
        if (name != null) {
    ...
    private static class VGroup {
        ...
        private void updateStateFromTypedArray(TypedArray a, XmlPullParser parser) {
            ...
            mRotate = TypedArrayUtils.getNamedFloat(a, parser, "rotation",
                    AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_GROUP_ROTATION, mRotate);

            mPivotX = a.getFloat(AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_GROUP_PIVOT_X, mPivotX);
            mPivotY = a.getFloat(AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_GROUP_PIVOT_Y, mPivotY);

            // This is added in API 11
            mScaleX = TypedArrayUtils.getNamedFloat(a, parser, "scaleX",
                    AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_GROUP_SCALE_X, mScaleX);

            // This is added in API 11
            mScaleY = TypedArrayUtils.getNamedFloat(a, parser, "scaleY",
                    AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_GROUP_SCALE_Y, mScaleY);

            mTranslateX = TypedArrayUtils.getNamedFloat(a, parser, "translateX",
                    AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_GROUP_TRANSLATE_X, mTranslateX);
            mTranslateY = TypedArrayUtils.getNamedFloat(a, parser, "translateY",
                    AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_GROUP_TRANSLATE_Y, mTranslateY);
    ...
    private static class VClipPath extends VPath {
        ...
        private void updateStateFromTypedArray(TypedArray a) {
            ...
            final String pathData =
                    a.getString(AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_CLIP_PATH_PATH_DATA);
            if (pathData != null) {
    ...
    private static class VFullPath extends VPath {
        ...
        private void updateStateFromTypedArray(TypedArray a, XmlPullParser parser) {
            ...
            final String pathData =
                    a.getString(AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_PATH_PATH_DATA);
            if (pathData != null) {
                mNodes = PathParser.createNodesFromPathData(pathData);
            }

            mFillColor = TypedArrayUtils.getNamedColor(a, parser, "fillColor",
                    AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_PATH_FILL_COLOR, mFillColor);
            mFillAlpha = TypedArrayUtils.getNamedFloat(a, parser, "fillAlpha",
                    AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_PATH_FILL_ALPHA, mFillAlpha);
            ...
            mStrokeColor = TypedArrayUtils.getNamedColor(a, parser, "strokeColor",
                    AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_COLOR, mStrokeColor);
            mStrokeAlpha = TypedArrayUtils.getNamedFloat(a, parser, "strokeAlpha",
                    AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_ALPHA, mStrokeAlpha);
            mStrokeWidth = TypedArrayUtils.getNamedFloat(a, parser, "strokeWidth",
                    AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_WIDTH, mStrokeWidth);
            mTrimPathEnd = TypedArrayUtils.getNamedFloat(a, parser, "trimPathEnd",
                    AndroidVectorResources.STYLEABLE_VECTOR_DRAWABLE_PATH_TRIM_PATH_END, mTrimPathEnd);
