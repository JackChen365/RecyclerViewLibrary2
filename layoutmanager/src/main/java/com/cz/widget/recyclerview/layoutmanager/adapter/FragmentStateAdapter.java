...
public abstract class FragmentStateAdapter extends
    ...
    /**
     * @param fragmentActivity if the {@link AbsCycleLayout} lives directly in a
    ...
    /**
     * @param fragment if the {@link AbsCycleLayout} lives directly in a {@link Fragment} subclass.
     *
    ...
    /**
     * @param fragmentManager of {@link AbsCycleLayout}'s host
     * @param lifecycle of {@link AbsCycleLayout}'s host
     *
     * @see FragmentStateAdapter#FragmentStateAdapter(FragmentActivity)
     * @see FragmentStateAdapter#FragmentStateAdapter(Fragment)
     */
    ...
    public final void restoreState(@NonNull Parcelable savedState) {
        ...
        if (bundle.getClassLoader() == null) {
            /** TODO(b/133752041): pass the class loader from {@link AbsCycleLayout.SavedState } */
    ...
    class FragmentMaxLifecycleEnforcer {
        private AbsCycleLayout.OnPageChangeCallback mPageChangeCallback;
        private RecyclerView.AdapterDataObserver mDataObserver;
        private LifecycleEventObserver mLifecycleObserver;
        private AbsCycleLayout mViewPager;
        ...
        void register(@NonNull RecyclerView recyclerView) {
            ...
            mPageChangeCallback = new AbsCycleLayout.OnPageChangeCallback() {
                @Override
            ...
            mViewPager.addOnPageChangeCallback(mPageChangeCallback);
        ...
        void unregister(@NonNull RecyclerView recyclerView) {
            AbsCycleLayout viewPager = inferViewPager(recyclerView);
            viewPager.removeOnPageChangeCallback(mPageChangeCallback);
        ...
        void updateFragmentMaxLifecycle(boolean dataSetChanged) {
            ...
            if (mViewPager.getScrollState() != AbsCycleLayout.SCROLL_STATE_IDLE) {
            ...
            if (currentItem >= getItemCount()) {
                 ...
                 * notified via {@link AbsCycleLayout.OnPageChangeCallback#onPageSelected(int)}  */
                return;
            }
        ...
        @NonNull
        private AbsCycleLayout inferViewPager(@NonNull RecyclerView recyclerView) {
            ViewParent parent = recyclerView.getParent();
            if (parent instanceof AbsCycleLayout) {
                return (AbsCycleLayout) parent;
            }
            throw new IllegalStateException("Expected CycleViewPager instance. Got: " + parent);
        }
    }
