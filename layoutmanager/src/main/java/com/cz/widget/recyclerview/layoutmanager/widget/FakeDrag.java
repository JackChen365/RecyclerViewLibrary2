...
/**
 * Provides fake dragging functionality to {@link AbsCycleLayout}.
 */
final class FakeDrag {
    private final AbsCycleLayout mViewPager;
    ...
    FakeDrag(AbsCycleLayout viewPager, ScrollEventAdapter scrollEventAdapter,
    ...
    boolean fakeDragBy(float offsetPxFloat) {
        ...
        boolean isHorizontal = mViewPager.getOrientation() == LinearLayoutManager.HORIZONTAL;
    ...
    boolean endFakeDrag() {
        ...
        // And fling or snap the AbsCycleLayout to its destination
