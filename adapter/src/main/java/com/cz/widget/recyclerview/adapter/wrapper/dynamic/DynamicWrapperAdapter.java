 ...
 * Such as insert advertising to the list. or cooperate with the {@link com.cz.widget.recyclerview.adapter.wrapper.drag.DragWrapperAdapter} to drag anything in a recycler view.
 *
 */
