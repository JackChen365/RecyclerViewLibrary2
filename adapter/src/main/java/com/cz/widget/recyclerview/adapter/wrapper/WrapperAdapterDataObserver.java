package com.cz.widget.recyclerview.adapter.wrapper;
 ...
 *
 * @see com.cz.widget.recyclerview.adapter.wrapper.header.HeaderWrapperAdapter
 * @see com.cz.widget.recyclerview.adapter.wrapper.dynamic.DynamicWrapperAdapter
 * @see WrapperAdapter
 */
